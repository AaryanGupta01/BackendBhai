...
CREATE INDEX IF NOT EXISTS idx_log_events_trace_id ON log_events(trace_id);
CREATE INDEX IF NOT EXISTS idx_log_events_span_id ON log_events(span_id);
CREATE INDEX IF NOT EXISTS idx_log_events_service_name ON log_events(service_name);
...
CREATE INDEX IF NOT EXISTS idx_log_events_trace_service ON log_events(trace_id, service_name);
CREATE INDEX IF NOT EXISTS idx_log_events_message ON log_events USING GIN(to_tsvector('english', message));
