...
-- Source: dev2.md §6.3
-- Author: Dev 5 (Abhinav) — extracted from Dev 2's spec for Dev 4 to wire into init scripts
...
-- ─── Request Summary View (powers GET /api/v1/requests) ─────────────
